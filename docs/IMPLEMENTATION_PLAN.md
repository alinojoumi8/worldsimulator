...
- **Backend:** proposal pipeline, cap-table math, distributions. **Frontend:** investment pages, cap tables, negotiation transcripts. **API:** investments, proposals. **DB:** vc_firms, proposals, investments, ownership_stakes (already seeded from founding equity).
